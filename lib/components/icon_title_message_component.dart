  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          Container(width: 40,height: 40,decoration: BoxDecoration(borderRadius: BorderRadius.circular(1000),color: (color ?? Color(0xFFB7DFF5)).withOpacity(0.2)),
              child: Center(child: Image.asset(assetImage ?? "",width: 20,height: 20,color: color ?? CustomColors.primary
              ))),
          SizedBox(height: 5),
          Text(message ?? "",style: TextStyle(fontWeight: FontWeight.w600,color: CustomColors.textColor,fontSize: 16)),
          SizedBox(height: 2),
