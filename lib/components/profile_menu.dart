...
class ProfileMenu extends StatelessWidget {
  ...
  final RxBool? observer;
  const ProfileMenu({super.key,required this.title,
    required this.image, required this.onTapped, this.logOutMenu,this.observer});

  @override
  Widget build(BuildContext context) {
    return AnimatedTap(
      onTap: onTapped,
      child: observer == null ? textButton() : Obx(() => observer?.value == true ? Center(child: Padding(
